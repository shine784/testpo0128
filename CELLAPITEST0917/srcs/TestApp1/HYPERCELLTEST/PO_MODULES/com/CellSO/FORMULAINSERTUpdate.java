...
import com.CellBO.FORMULAEXECUTE;

/**************************************************************************************************************
* 화일명 : FORMULAINSERTUpdate.class
* 사용프로그램 : FORMULAINSERTUpdate
* 설명 :  
**************************************************************************************************************/
@ServiceObject
public class FORMULAINSERTUpdate implements com.tmax.proobject.model.service.ServiceObject<com.CellDO.CELLINSERTDO, com.CellDO.AFTERINSERTMSG>
{
	...
	public com.CellBO.FORMULAEXECUTE var1 = new com.CellBO.FORMULAEXECUTE();
